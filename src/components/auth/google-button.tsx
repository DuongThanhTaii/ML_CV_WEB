...
export function GoogleButton({ nextPath = '/dashboard' }: { nextPath?: string }) {
    ...
    <Button type="button" variant="outline" className="w-full" onClick={handleClick} disabled={loading}>
      {loading ? (
        ...
        <svg className="size-4" viewBox="0 0 48 48" aria-hidden="true">
          ...
          <path
            fill="#4CAF50"
            d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.2 2.4-5.2 0-9.6-3.3-11.3-8l-6.5 5C9.4 39.5 16.1 44 24 44z"
          />
          <path
            fill="#1976D2"
